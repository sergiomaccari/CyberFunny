...
namespace CyberMetro {
	namespace Fases {
			...
			: Fase(jogador1, jogador2)
		{
			...
			this->areaDeSaida = sf::FloatRect(32.0f * 85.0f, 32.0f * 12.0f, 64.0f, 64.0f);//talvez ajeitar futuramente
			...
			{
				Fase::criarCenario("tiledcybermapa1.json");
			}
		}
